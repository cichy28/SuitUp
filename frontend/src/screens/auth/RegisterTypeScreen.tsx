	...
	return (
		<ScrollView className="flex-1 bg-neutral-50">
			<View className="p-6 flex-1">
				...
				<View className="mt-6">
					<Button title="Kontynuuj" onPress={handleContinue} fullWidth disabled={!selectedType} className="mb-4" />
					<Button title="Wróć do logowania" onPress={handleLogin} variant="outline" fullWidth />
				</View>

				<View className="mt-8 items-center">
					<Text className="text-neutral-400 text-sm">© 2025 Suit Creator. Wszelkie prawa zastrzeżone.</Text>
				</View>
			</View>
		</ScrollView>
	);
