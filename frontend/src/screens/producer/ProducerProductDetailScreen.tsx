	...
	return (
		<ScrollView style={styles.container}>
			<View style={styles.header}>
				...
				<Button onPress={handleEditProduct} size="sm" variant="outline" leftIcon="pencil-outline">
					Edytuj
				</Button>
			</View>
				...
				{product.styles.length > 0 ? (
					<>
						...
						<View style={styles.addButtonContainer}>
							<Button onPress={handleAddStyle} variant="outline" size="sm">
								Dodaj styl
							</Button>
						</View>
					</>
					...
					<View style={styles.emptyStateContainer}>
						...
						<Button onPress={handleAddStyle} variant="primary" size="sm">
							Dodaj pierwszy styl
						</Button>
					</View>
				)}
			...
			<Section title="Materiały">
				{product.materials.length > 0 ? (
					<>
						...
						<View style={styles.addButtonContainer}>
							<Button onPress={handleAddMaterial} variant="outline" size="sm">
								Dodaj materiał
							</Button>
						</View>
					</>
					...
					<View style={styles.emptyStateContainer}>
						...
						<Button onPress={handleAddMaterial} variant="primary" size="sm">
			...
			<Section title="Wykończenia">
				{product.finishes.length > 0 ? (
					<>
						...
						<View style={styles.addButtonContainer}>
							<Button onPress={handleAddFinish} variant="outline" size="sm">
								Dodaj wykończenie
							</Button>
						</View>
					</>
					...
					<View style={styles.emptyStateContainer}>
						...
						<Button onPress={handleAddFinish} variant="primary" size="sm">
			...
			<View style={styles.deleteButtonContainer}>
				<Button onPress={handleDeleteProduct} variant="danger" fullWidth>
					Usuń produkt
				</Button>
			</View>

			<Modal isVisible={deleteModalVisible} onClose={() => setDeleteModalVisible(false)} title="Usuń produkt">
				<View>
					<Text style={styles.modalText}>Czy na pewno chcesz usunąć ten produkt? Ta operacja jest nieodwracalna.</Text>
					<View style={styles.modalButtons}>
						<Button onPress={() => setDeleteModalVisible(false)} variant="outline" style={styles.modalButton}>
							Anuluj
						</Button>
						<Button onPress={confirmDelete} variant="danger" style={styles.modalButton}>
							Usuń
						</Button>
					</View>
				</View>
