	...
	return (
		<ScrollView style={styles.container}>
			...
			<Card style={styles.configuratorCard}>
				<View style={styles.visualizationContainer}>
					...
					<Text style={styles.visualizationText}>
						Wizualizacja {currentView === "front" ? "przód" : currentView === "back" ? "tył" : "bok"}
					</Text>
				</View>
			...
			<Section title="Twoja konfiguracja">
				<View style={styles.configurationDetails}>
					...
					<View style={styles.detailRow}>
						...
						<Text style={styles.detailValue}>{product.styles.find((s) => s.id === selectedStyle)?.name || ""}</Text>
					</View>
					...
					<View style={styles.detailRow}>
						...
						<Text style={styles.detailValue}>{product.finishes.find((f) => f.id === selectedFinish)?.name || ""}</Text>
					</View>
				</View>
			</Section>
			...
			<Card style={styles.summaryCard}>
				...
				<Button onPress={handleCheckout} fullWidth style={styles.checkoutButton}>
