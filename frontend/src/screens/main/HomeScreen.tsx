		...
		<ScrollView style={styles.container}>
			<View style={styles.content}>
				<View style={styles.header}>
					...
					<Text style={styles.subtitle}>Witaj, {user?.name}! Twoje spersonalizowane ubrania na wyciągnięcie ręki</Text>
				</View>
				...
				<Card style={styles.measurementsCard}>
					<View style={styles.measurementsContent}>
						...
						<Text style={styles.cardDescription}>Wprowadź swoje wymiary, aby otrzymać idealne dopasowanie</Text>
						<Button onPress={handleMeasurements} variant="primary">
							Wprowadź wymiary
						</Button>
					</View>
				</Card>
				...
				<Section title="Polecane produkty">
					...
					<View style={styles.viewAllContainer}>
						<Button onPress={handleViewAllProducts} variant="outline" fullWidth>
