...
import ProducerManagePropertiesScreen from "../screens/producer/ProducerManagePropertiesScreen";
import ProducerManageVariantsScreen from "../screens/producer/ProducerManageVariantsScreen";
import { FileManagerScreen } from "../screens/producer/FileManagerScreen";
...
export type ProducerProductsStackParamList = {
	...
	ManageVariants: { productId: string };
...
const ProductsNavigator = () => {
	return (
		<ProductsStack.Navigator>
			<ProductsStack.Screen name="ProductsList" component={ProductsScreen} options={{ title: "Katalog produktów" }} />
			<ProductsStack.Screen
				name="ProductDetail"
				component={ProductDetailScreen}
				options={{ title: "Szczegóły produktu" }}
			/>
			<ProductsStack.Screen name="Configurator" component={ConfiguratorScreen} options={{ title: "Konfigurator" }} />
			<ProductsStack.Screen name="Checkout" component={CheckoutScreen} options={{ title: "Zamówienie" }} />
		</ProductsStack.Navigator>
	);
};
...
const ProfileNavigator = () => {
	return (
		<ProfileStack.Navigator>
			<ProfileStack.Screen name="ProfileMain" component={ProfileScreen} options={{ title: "Mój profil" }} />
			<ProfileStack.Screen name="Measurements" component={MeasurementsScreen} options={{ title: "Moje wymiary" }} />
		</ProfileStack.Navigator>
	);
};
...
const OrdersNavigator = () => {
	return (
		<OrdersStack.Navigator>
			<OrdersStack.Screen name="OrdersList" component={OrdersScreen} options={{ title: "Moje zamówienia" }} />
			<OrdersStack.Screen
				name="OrderDetail"
	...
	return (
		<ProducerProductsStack.Navigator>
			...
			<ProducerProductsStack.Screen
				...
				component={ProducerManagePropertiesScreen}
				options={{ title: "Zarządzanie właściwościami" }}
			/>
			<ProducerProductsStack.Screen
				name="ManageVariants"
				component={ProducerManageVariantsScreen}
				options={{ title: "Zarządzanie wariantami" }}
			/>
			<ProducerProductsStack.Screen
				name="FileManager"
				component={FileManagerScreen}
				options={{ title: "Menedżer plików" }}
			/>
			<ProducerProductsStack.Screen
				name="AddStyle"
...
const ClientNavigator = () => {
	return (
		...
		>
			<MainTab.Screen name="Home" component={HomeScreen} options={{ title: "Strona główna", headerShown: false }} />
			<MainTab.Screen
				name="Products"
				component={ProductsNavigator}
				options={{ title: "Produkty", headerShown: false }}
			/>
			<MainTab.Screen name="Profile" component={ProfileNavigator} options={{ title: "Profil", headerShown: false }} />
			<MainTab.Screen name="Orders" component={OrdersNavigator} options={{ title: "Zamówienia", headerShown: false }} />
		</MainTab.Navigator>
	);
};
